...
class testBGSub():
    ...
    def __init__(self):
        ...
        self.lr = -1
        self.counter = 0
        self.rgb_sub = rospy.Subscriber("/cam_side/color/image_raw", Image, self.img_cb)
    ...
    [
        ...
        self.model.eval()
        self.model.load_state_dict(torch.load('/home/panda2/catkin_ws/src/tuni-panda/TuniMetricsCompetition/metrics_vision/models/gearside2_50epochs.pth',map_location=torch.device('cpu')))
        self.classnames = ['left', 'right']
